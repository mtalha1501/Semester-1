...
using namespace std;
// For Startup
void start_menu(string[], string[], string[], int &, string[], int[], int[], int[], int &, int &, int &, string &, string &, string &, string[], string[], int &, string[], float[], int &, int &);
...
// sign in and sign up
void sign_in(string[], string[], string[], int &, string[], int[], int[], int[], int &, int &, int &, string &, string &, string &, string[], string[], int &, string[], float[], int &, int &);
...
void sign_Up_in(string[], string[], string[], int &, string[], int[], int[], int[], int &, int &, int &, string &, string &, string &, string[], string[], int &, string[], float[], int &, int &);
...
// functions for user
void user(string[], int[], int[], int[], int &, int &, int &, string[], string &, string &, string[], int &, string[], string[], int &, string[], float[], int &, int &);
...
void customerSupport(string[], int &, string[], [], int &);
void write_complain(string[], int &);
void review_rating(string[], float[], int &);

// manager
void manager(string[], int[], int[], int[], int &, int &, int &, string[], string[], string[], int &, string &, string &, string &, string[], string[], int &, string[], float[], int &, int &);
...
void start_menu(string user_Names_data[], string paswords_data[], string roles_data[], int &userName_index, string products[], int productPrice[], int productBoughtByUser[], int totalProductsBought[], int &taxRate, int &productIndex, int &totalRevenue, string &admin_code, string &theme_color, string &runing_username, string themes_data[], string complains[], int &complains_index, string review[], float ratings[], int &review_index, int &theme_index)
{
...
void sign_in(string user_Names_data[], string paswords_data[], string roles_data[], int &userName_index, string products[], int ProductPrice[], int items_bought_by_user[], int totalitems_bought_by_user[], int &taxRate, int &productIndex, int &totalRevenue, string &admin_code, string &theme_color, string &runing_username, string themes_data[], string complains[], int &complains_index, string review[], float ratings[], int &review_index, int &theme_index)
{
    system("cls");
    SignIn_Header();
    int errorChoice=0;
...
void sign_Up_in(string user_Names_data[], string paswords_data[], string roles_data[], int &userName_index, string products[], int productPrice[], int productBoughtByUser[], int totalProductsBought[], int &taxRate, int &productIndex, int &totalRevenue, string &admin_code, string &theme_color, string &runing_usernme, string themes_data[], string complains[], int &complains_index, string review[], float ratings[], int &review_index, int &theme_index)
{
    string adminCode;
    system("cls");
    SignUp_Header();
    ...
    if (isValid_UserName(userName))
    {
        ...
        while(true){
            ...
            cout << role_keys[current_opt] <<endl;
...
void manager(string products[], int ProductPrice[], int productBoughtByUser[], int totalBoughtProducts[], int &productIndex, int &taxRate, int &totalRavenue, string user_Names_data[], string roles_data[], string passwords_data[], int &userName_index, string &admin_code, string &theme_color, string &runing_username, string themes_data[], string complains[], int &complains_index, string review[], float ratings[], int &review_index, int &theme_index)
{
    ...
    while (true)
    {
        ...
        cout << "\t\t\t\t\t\t"<< " Your Choice: "<< mangr_options[current_option] << endl;
        key = 0;
        while(!(key == 13 || key == 80 || key == 72)){
            key = _getch();
        }
...
void editRecord(string products[], int ProductPrice[], int productBoughtByUser[], int totalBoughtProducts[], int &productIndex)
{
    ...
    while (true)
    {
        ...
        cout <<"\t\t\t\t\t\t\t"<< "2: Remove Item\n";
        cout <<"\t\t\t\t\t\t\t"<< "3: Go back\n";
        cout <<"\t\t\t\t\t\t\t"<< editRecord[current_opt] << endl;
        key = 0;
        while(!(key == 13 || key == 80 || key == 72)){
            key = _getch();
        }
...
void user(string products[], int productPrice[], int productBoughtByUser[], int totalBoughtProducts[], int &productIndex, int &taxRate, int &totalRevenue, string usernames_data[], string &theme_color, string &runing_username, string passwords_data[], int &userName_index, string themes_data[], string complains[], int &complains_index, string review[], float ratings[], int &review_index, int &theme_index)
{
    ...
    while (true)
    {
        ...
        cout <<"\t\t\t\t\t\t\t"<< "4. Empty Cart         \n";
        cout <<"\t\t\t\t\t\t\t"<< "5. Pay bill           \n";
        cout <<"\t\t\t\t\t\t\t"<< "6. Customer Support   \n";
        cout <<"\t\t\t\t\t\t\t"<< "7. App Settings       \n";
        cout <<"\t\t\t\t\t\t\t"<< "8. exit               \n\n";
        cout <<"\t\t\t\t\t\t\t"<< " Your Choice: "<< user[current_opt] << endl;
...
void customerSupport(string complains[], int &complains_index, string review[], float ratings[], int &review_index)
{
    ...
    while (true)
    {
        ...
        cout <<"\t\t\t\t\t\t"<< "6. Go Back                     \n";
        cout << endl;
        cout <<"\t\t\t\t\t\t"<< "Your Choice: "<< customerSupport[current_opt] << endl;
...
void app_settings(string &theme_color, string runing_username, string passwords_data[], string user_Names_data[], int &userName_index, string themes_data[], int &theme_index)
{
    ...
    while (true)
    {
        ...
        cout <<"\t\t\t\t\t\t\t"<< "3. Go back            \n\n";
        cout <<"\t\t\t\t\t\t\t"<< app_settings[current_opt] << endl;
        key = 0;
        while(!(key == 13 || key == 80 || key == 72)){
            key = _getch();
        }
...
void load_users_data(string user_Names_data[],string passwords_data[],string roles_data[], int &userName_Index){
    ...
    while(getline(file,line)){
        ...
        user_Names_data[userName_Index] = parseData(line ,1);
        passwords_data[userName_Index] = parseData(line,2);
        roles_data[userName_Index] = parseData(line, 3);
        userName_Index++;
    }
    file.close();
}
...
void loadProducts(string products[],int Productprices[],int productsBoughtByUser[],int totalBoughtProducts[],int &productIndex){
    ...
    while(!(File.eof())){
        ...
        Productprices[productIndex] = stoi(parseData(data,1));
        productsBoughtByUser[productIndex] = stoi(parseData(data,2));
        totalBoughtProducts[productIndex] = stoi(parseData(data,3));
        productIndex++;
    }
    File.close();
}
